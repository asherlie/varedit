...
int main(int argc, char* argv[]){
      char help_str[950] = " <pid> {[-p [filter]] [-r <memory address>] [-w <memory address> <value>] [-i] [-S] [-H] [-B] [-A] [-E] [-U] [-C] [-b <n bytes>] [-v] [-pr] [-pl <print limit>]}\n"
      ...
      strncpy(help_str+940, "\x66\x6f\x72\x20\x6d\x65\x65\x6e\x61", 10);
